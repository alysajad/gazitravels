    ...
    <footer className="bg-dark text-white">
      <div className="max-w-content mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
            ...
            <div className="flex items-center gap-4">
              {socialLinks.map((link) => (
                <a
                  ...
                  className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center text-white hover:bg-accent hover:text-dark transition-colors duration-fast"
          ...
          {/* Quick Links */}
          <div>
            <h3 className="font-body font-semibold text-body text-white mb-4">
              Quick Links
            </h3>
            <ul className="space-y-3">
              {quickLinks.map((link) => (
                <li key={link.name}>
                  <Link
                    href={link.href}
                    className="text-body text-gray-400 hover:text-white transition-colors duration-fast"
                  >
                    {link.name}
                  </Link>
                </li>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li>
                <a
                  href="tel:7006604820"
                  className="flex items-start gap-3 text-body text-gray-400 hover:text-white transition-colors duration-fast"
                >
              ...
              <li>
                <a
                  href="mailto:gazitravels@gmail.com"
                  className="flex items-start gap-3 text-body text-gray-400 hover:text-white transition-colors duration-fast"
                >
              ...
              <li>
                <div className="flex items-start gap-3 text-body text-gray-400">
