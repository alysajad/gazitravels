...
export default function UmrahPackageDetails({ params }: { params: { slug: string } }) {
              ...
              <div className="flex-1">
                ...
                <div className="grid grid-cols-2 gap-6 mb-12">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-xs text-gray-500 uppercase tracking-wider font-semibold">Group Size</p>
                      <p className="font-medium text-dark">{pkg.groupSize}</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-full bg-gray-100 flex items-center justify-center text-dark">
                    ...
                    <div>
                      <p className="text-xs text-gray-500 uppercase tracking-wider font-semibold">Makkah</p>
                      <p className="font-medium text-dark">{pkg.nightsMakkah} Nights</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-full bg-gray-100 flex items-center justify-center text-dark">
                    ...
                    <div>
                      <p className="text-xs text-gray-500 uppercase tracking-wider font-semibold">Madinah</p>
                      <p className="font-medium text-dark">{pkg.nightsMadinah} Nights</p>
                    </div>
                  </div>
                </div>
                ...
                <h3 className="text-2xl font-display font-bold text-dark mb-6">Included Ziyarat</h3>
                <div className="flex flex-wrap gap-2 mb-12">
                  {pkg.ziyarat.map((place, idx) => (
                ...
                <div className="bg-dark text-white rounded-3xl p-8 sticky top-32">
                  ...
                  <div className="space-y-4 mb-8">
                    <div className="border-b border-gray-800 pb-4">
                      <p className="text-sm text-gray-400 uppercase tracking-wider font-semibold mb-1">Accommodation</p>
                      <p className="font-medium">{pkg.accommodation}</p>
                    </div>
                    <div className="border-b border-gray-800 pb-4">
                      <p className="text-sm text-gray-400 uppercase tracking-wider font-semibold mb-1">Meals</p>
                      <p className="font-medium">{pkg.meals}</p>
                    </div>
                  </div>

                  <CTAButton 
                    href={`https://wa.me/917006604820?text=Assalamu%20Alaikum%2C%20I'm%20interested%20in%20the%20${pkg.title}%20Umrah%20Package.`}
                    variant="accent" 
